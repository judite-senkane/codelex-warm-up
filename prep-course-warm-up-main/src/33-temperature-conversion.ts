...
const fahrenheitToCelsius = (tempInFahrenheit: number): number => Number(((tempInFahrenheit - 32) * 5/9).toFixed(1));
const celsiusToFahrenheit = (tempInCelsius: number): number => Number(((tempInCelsius * 9/5) + 32).toFixed(1));
